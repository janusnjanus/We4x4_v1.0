...
public class UploadPictures extends android.support.v4.app.Fragment{
    ...
    long numOfAdrs;
    Uri RealFilePath, selectedImgPath;
        ...
        public ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            uploadContent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    uploadTask.execute(String.valueOf(picture));
                }
            });
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data == null) {
            ...
            selectedImgPath = data.getData();
            Log.i("MyTag_uploadFile", selectedImgPath.toString());
...
//                .setImageURI(selectedImgPath);
    ...
    class UploadTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(UploadPictures.this.getContext(),
