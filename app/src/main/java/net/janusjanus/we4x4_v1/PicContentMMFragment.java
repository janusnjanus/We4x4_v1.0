...
public class PicContentMMFragment extends android.support.v4.app.Fragment {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.item_pic_mm, parent, false));
            ...
            submitRating.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    firebaseDataRef.child("images").child(public_id).child("author").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                    ...
                    firebaseDataRef.child("images").child(public_id).child("author_id").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    firebaseDataRef.child("images").child(public_id).child(UserID).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(final DataSnapshot dataSnapshot) {
                            ...
                            if(userVotStat){
                                ...
                                firebaseDataRef.child("images").child(public_id).child("rating").runTransaction(new Transaction.Handler() {
                                    ...
                                    public Transaction.Result doTransaction(MutableData currentData) {
                                        if(currentData.getValue() == null){
                                            ...
                                            firebaserRefMM.child("rating").child("images").child(author_id_String).child(public_id).runTransaction(new Transaction.Handler() {
                                                @Override
                                                public Transaction.Result doTransaction(MutableData mutableData) {
                                            ...
                                            firebaseDataRef.child("images").child(public_id).child(UserID).setValue(newRating);
                                            firebaserRefMM.child("rating").child("images").child(author_id_String).child(public_id).setValue((Long) currentData.getValue() + newRating);
