...
public class Member extends AppCompatActivity{
    ...
    @Bind(R.id.uploadSectionBtn)
    Button uploadSectionBtn;
    @Bind(R.id.gpsLocationBtn)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("MyTag_onCreate","Members_Loaded");
        ...
        uploadSectionBtn.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public boolean onNavigationItemSelected(MenuItem item) {
                        ...
                        if(id == R.id.navHome) {
                            ...
                            AlertDialog.Builder builder =
                                    new AlertDialog.Builder(Member.this, R.style.AppTheme_Dark_Dialog);
