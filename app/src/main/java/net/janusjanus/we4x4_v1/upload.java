...
public class upload extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
                    ...
                    public boolean onNavigationItemSelected(MenuItem item) {
                        ...
                        if (id == R.id.navHome) {
                            ...
                            AlertDialog.Builder builder =
                                    new AlertDialog.Builder(upload.this, R.style.AppTheme_Dark_Dialog);
...
// go to the settings
        if (!enabled) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(upload.this, R.style.AppTheme_Dark_Dialog);
